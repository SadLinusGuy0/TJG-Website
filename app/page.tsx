    ...
    <div className="index">
      <div className="top-app-bar">
        <div className="top-app-bar-container settings-only">
          <Link href="/settings" className="top-app-bar-icon" aria-label="Settings" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '50%', cursor: 'pointer' }}>
