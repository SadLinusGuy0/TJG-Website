...
export default async function BlogIndex({ searchParams }: Props) {
  ...
  // Create a map of category IDs to names (convert to object for client component)
  ...
  return (
    <div className="index">
      ...
      <div className="containers">
        <Navigation />
        <BlogSearchProvider initialPosts={posts}>
        <div className="main-content" style={{ paddingTop: 0 }}>
          <div className="top-app-bar">
              <div className="top-app-bar-container both-buttons">
                <TopAppBarSearch posts={posts} />
          ...
          {/* Posts Section */}
          {posts.length > 0 ? (
              <BlogPostsWithSearch initialPosts={posts} categoryMap={categoryMapObj} />
          ) : (
