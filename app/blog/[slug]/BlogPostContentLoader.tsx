...
import { fetchPostBySlug, fetchPageBySlug, getFeaturedImageUrlAsync, WPPost } from '../../../lib/wordpress';
...
export default function BlogPostContentLoader() {
  ...
  useEffect(() => {
    async function loadPostContent() {
      ...
      try {
        ...
        const fetchedContent = await getContentForSlug(slug);
        ...
        try {
          const imageUrl = await getFeaturedImageUrlAsync(fetchedContent);
            ...
            <div className="blank-div">
              ...
              <div className="container settings">
                <div className="body-text">
                  <p>{error || 'The post you are looking for could not be found.'}</p>
                </div>
              </div>
            </div>
          </div>
