              ...
              <a href="https://youtube.com/@thatjoshguy08/" className="list3" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                <div className="shape">
                  ...
                  <svg width="24" height="17" viewBox="0 0 24 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.54545 11.9817V4.86931L15.8182 8.4257L9.54545 11.9817ZM23.4985 2.63135C23.2225 1.59555 22.4092 0.779906 21.3766 0.503086C19.505 2.67029e-07 12 0 12 0C12 0 4.495 2.67029e-07 2.62335 0.503086C1.59076 0.779906 0.777485 1.59555 0.501509 2.63135C0 4.50865 0 8.42553 0 8.42553C0 8.42553 0 12.3424 0.501509 14.2197C0.777485 15.2555 1.59076 16.0712 2.62335 16.3481C4.495 16.8511 12 16.8511 12 16.8511C12 16.8511 19.505 16.8511 21.3766 16.3481C22.4092 16.0712 23.2225 15.2555 23.4985 14.2197C24 12.3424 24 8.42553 24 8.42553C24 8.42553 24 4.50865 23.4985 2.63135Z" fill="var(--primary)"/>
                  </svg>
                </div>
                <div className="test-toggle-group">
