      ...
      <div className="blank-div">
        ...
        <label htmlFor="experimental-ui-toggle" className="list3" style={{ cursor: 'pointer' }}>
          <div className="test-toggle-group">
            <div className="body-text">Enable new UI</div>
            <div className="information-wrapper">
              <div className="information">Try out the new redesigned UI, with a more modern look and feel</div>
            </div>
          </div>
        ...
        {experimentalUI && (
          <label htmlFor="progressive-blur-toggle" className="list3" style={{ cursor: 'pointer', marginTop: 8 }}>
            <div className="test-toggle-group">
              ...
              <div className="information-wrapper">
                <div className="information">Enable or disable the new blur effects on scroll</div>
              </div>
            </div>
            <div className="toggle-switch">
              <input
